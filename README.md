...
The data is split into a training and test dataset using a stratified 85/15 split. Preprocessing includes the removal of extreme feature values, robust scaling and variance thresholding. Feature selection (SelectKBest, PCA, or none) and classifier choice are optimized using nested cross-validation.
